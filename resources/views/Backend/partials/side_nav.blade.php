      ...
      <ul class="nav flex-column">
        ...
        <li class="nav-item">
            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button"
              ...
              <div class="dropdown-menu">
                    <a class="dropdown-item nav-item" href="{{route('admincontact.index')}}">Message List</a>
                    <a class="dropdown-item nav-item" href="{{route('admincontact.trashed')}}">Trashed Message</a>
              </div>
        </li>
        <li class="nav-item">
            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button"
